...
2. Download the installation tools from releases: [install_tools](https://github.com/moja-global/GCBM.RiftValley/releases/tag/install_tools), and unzip them into `Standalone_GCBM\tools` folder.
